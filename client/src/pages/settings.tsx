    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-gray-800 px-4 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-end">
          <Button
            size="sm"
            className="w-8 h-8 bg-gradient-to-b from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white hover:text-red-400 active:text-red-500 rounded-full p-0 border border-gray-300 hover:border-gray-200 shadow-lg shadow-gray-800/50 hover:shadow-gray-700/60 transition-all duration-200 active:scale-95"
            style={{
